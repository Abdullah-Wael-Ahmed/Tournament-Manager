...
<div class="oxygen ms-5 mt-5" style="font-size: 3rem">
    {{Auth('teacher')->user()->name}} Events
    <a href="{{route('event.add')}}" class="btn btn-outline-success" class="oxygen">Add an Event</a>
